        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:flex lg:items-center">
            <ul className="flex space-x-6">
              <li>
                <a href="javascript:void(0)">
                  <svg xmlns="http://www.w3.org/2000/svg" className="fill-gray-300fill-white w-7 h-7" viewBox="0 0 24 24">
              ...
              <li>
                <a href="javascript:void(0)">
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" className="fill-gray-300fill-white w-7 h-7" viewBox="0 0 24 24">
          ...
          <div>
            <h4 className="text-lg mb-6 dark:text-red-600">Useful links</h4>
            <ul className="space-y-4 pl-2">
              <li>
                <a href="javascript:void(0)" className="text-gray-600 text-sm">Featured</a>
              </li>
              <li>
                <a href="javascript:void(0)" className="text-gray-600 text-sm">New Arrivals</a>
              </li>
              <li>
                <a href="javascript:void(0)" className="text-gray-600 text-sm">New Arrivals</a>
              </li>
          ...
          <div>
            <h4 className="text-lg mb-6 ">Information</h4>
            <ul className="space-y-4 pl-2">
              <li>
                <a href="javascript:void(0)" className="text-gray-600 text-sm">About Us</a>
              </li>
              <li>
                <a href="javascript:void(0)" className="text-gray-600 text-sm">Terms &amp; Conditions</a>
              </li>
              <li>
                <a href="javascript:void(0)" className="text-gray-600 text-sm">Privacy Policy</a>
              </li>
              <li>
                <a href="javascript:void(0)" className="text-gray-600 text-sm">Sale</a>
              </li>
              <li>
                <a href="javascript:void(0)" className="text-gray-600 text-sm">Documentation</a>
              </li>
            </ul>
          </div>
        </div>

        <p className="text-gray-600 text-sm mt-10">© ReadymadeUI. All rights reserved.</p>
      </div>
    </footer>
  );
};
